...
elseif ch==2
	baud_rate = input('\nEnter the baud rate : ');
	bit_rate_uni = baud_rate;
	bit_rate_mlt = 0.75*baud_rate;
elseif ch==3
	band_width = input('\nEnter the bandwidth rate : ');
	bit_rate_uni = band_width;
...
text(n/bit_rate_uni+0.2/bit_rate_uni, 0.0, strcat(strcat('Baud Rate = ', num2str(bit_rate_uni)), ' baud'))
text(n/bit_rate_uni+0.2/bit_rate_uni, -0.5, strcat(strcat('Bandwidth = ', num2str(bit_rate_uni)), ' bps'))
